...
class unet(nn.Module):
    ...
    def __init__(self, in_channels, num_classes):
        ...
        # Upsampling Path
        self.up_convolution_1 = UpSample(512, 256)            # First upsampling layer
        self.up_convolution_2 = UpSample(256, 128)             # Second upsampling layer
        self.up_convolution_3 = UpSample(128, 64)             # Third upsampling layer
        self.up_convolution_4 = UpSample(64, 32)              # Fourth upsampling layer
